<section class="content-header">
	<div class="btn-group">
		...
		<a class="btn btn-bitbucket btn-sm" href="<?= Yii::app()->createUrl("singkatan/create") ?>">Tambah Singkatan</a>
	</div>
...
<section class="content">
	<div class="box box-info">
		<div class="box-header with-border">
			<h3 class="box-title">Singkatan</h3>
...
$(document).ready(function(){
	$("#btn-refresh").on("click",function(e){
		$.fn.yiiGridView.update('singkatan-grid',{
			data: $(this).serialize()
		});
	});
});
