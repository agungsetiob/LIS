<section class="content-header">
	<div class="btn-group">
		...
		<a class="btn btn-bitbucket btn-sm" href="<?= Yii::app()->createUrl("singkatan") ?>">Kembali</a>
	</div>
	  
	<ol class="breadcrumb">
		<li><a href="<?= Yii::app()->createUrl("dashboard") ?>"><i class="fa fa-dashboard"></i> Dashboard </a></li>
		<li><a href="<?= Yii::app()->createUrl("singkatan") ?>"> Singkatan </a></li>
		<li>Add</li>
	</ol>
</section>
...
<section class="content">
    <div class="box box-info">
		<div class="box-header with-border">
			<h3 class="box-title">Tambah Singkatan</h3>
