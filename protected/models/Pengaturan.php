...
class Pengaturan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('attribute, value', 'length', 'max'=>50),
	...
	public static function item($attribute)
	{
		$model=self::model()->find(array('condition'=>'attribute=:attribute','params'=>array(':attribute'=>$attribute),));
		return $model->value;
	}
}
