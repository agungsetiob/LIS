...
class PaketDetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_paket', 'required'),
			array('id_paket, id_kode', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_paket, id_kode', 'safe', 'on'=>'search'),
		);
	}
	...
	public static function getTotalPemeriksaan($id)
	{
		$sql = "SELECT COUNT(*) AS total FROM paket_detail WHERE id_paket='$id'";
